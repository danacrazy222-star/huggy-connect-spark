...
import { X, Swords, BookOpen, Star, Globe } from "lucide-react";
            ...
            >
              ...
              <div className="relative p-6 pt-8 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-muted-foreground mb-5">
                  اشترِ الكتاب الرقمي وافتح تحدي حصري يظهر لجميع اللاعبين!
                </p>
                ...
                <p className="text-[10px] text-muted-foreground mt-3">
                  * التحدي يُفتح فوراً بعد الشراء ويظهر لجميع اللاعبين
                </p>
              </div>
            </motion.div>
          </motion.div>
