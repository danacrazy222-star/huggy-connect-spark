...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    matchmaking: "Matchmaking", joiningQueue: "Joining queue...", yourPosition: "Your Position", inQueue: "in queue", estimatedWait: "Estimated wait", playersInQueue: "Players in Queue", betAmount: "Bet Amount", points: "Points", leaveQueue: "Leave Queue", matchFound: "Match Found!", getReady: "Get ready to play!", startingGame: "Starting game...", botLabel: "Bot", you: "You", realPlayer: "Real Player", loginToPlay: "Login to play multiplayer", queueBotFallback: "No players? Bot joins automatically",
    treasureRush: "Treasure Rush", treasureRushDesc: "Open boxes & collect gold before time runs out!", treasureBoxTypes: "Box Types", treasureGold: "Gold", treasureRare: "Rare Gem", treasureTrap: "Trap", treasureSteal: "Steal", treasureDouble: "Double Gold", treasureEmpty: "Empty", treasureSolo: "👤 Solo Mode", treasureMultiplayer: "👥 Multiplayer", treasureGetReady: "Get ready to rush!", treasureRound: "Round", treasureGoldPts: "Gold!", treasureRarePts: "Rare Gem!", treasureTrapPts: "Trap!", treasureStolen: "Stolen!", treasureDoubleActive: "Double Gold Active!", treasureNothing: "Empty box", treasureYouWon: "YOU WON! 🏆", treasureGameOver: "Game Over!", treasurePlayAgain: "Play Again"
  },
  ar: {
    ...
    matchmaking: "البحث عن خصم", joiningQueue: "الانضمام للطابور...", yourPosition: "ترتيبك", inQueue: "في الطابور", estimatedWait: "الوقت المتوقع", playersInQueue: "اللاعبون في الطابور", betAmount: "مبلغ الرهان", points: "نقاط", leaveQueue: "مغادرة الطابور", matchFound: "تم إيجاد خصم!", getReady: "استعد للعب!", startingGame: "بدء اللعبة...", botLabel: "بوت", you: "أنت", realPlayer: "لاعب حقيقي", loginToPlay: "سجّل دخول للعب ضد لاعبين", queueBotFallback: "ما في لاعبين؟ البوت بيدخل تلقائياً",
    treasureRush: "كنز الغرفة", treasureRushDesc: "افتح الصناديق واجمع الذهب قبل انتهاء الوقت!", treasureBoxTypes: "أنواع الصناديق", treasureGold: "ذهب", treasureRare: "جوهرة نادرة", treasureTrap: "فخ", treasureSteal: "سرقة", treasureDouble: "ذهب مضاعف", treasureEmpty: "فارغ", treasureSolo: "👤 لعب فردي", treasureMultiplayer: "👥 جماعي", treasureGetReady: "استعد للمغامرة!", treasureRound: "الجولة", treasureGoldPts: "ذهب!", treasureRarePts: "جوهرة!", treasureTrapPts: "فخ!", treasureStolen: "سرقة!", treasureDoubleActive: "ذهب مضاعف!", treasureNothing: "صندوق فارغ", treasureYouWon: "فزت! 🏆", treasureGameOver: "انتهت اللعبة!", treasurePlayAgain: "العب مرة ثانية"
  },
  fr: {
    ...
    matchmaking: "Recherche de match", joiningQueue: "Rejoindre la file...", yourPosition: "Votre Position", inQueue: "en file", estimatedWait: "Attente estimée", playersInQueue: "Joueurs en file", betAmount: "Mise", points: "Points", leaveQueue: "Quitter la file", matchFound: "Match trouvé!", getReady: "Préparez-vous!", startingGame: "Lancement...", botLabel: "Bot", you: "Vous", realPlayer: "Joueur réel", loginToPlay: "Connectez-vous pour jouer", queueBotFallback: "Pas de joueurs? Le bot rejoint automatiquement",
    treasureRush: "Ruée au Trésor", treasureRushDesc: "Ouvrez les coffres et récoltez l'or avant la fin!", treasureBoxTypes: "Types de coffres", treasureGold: "Or", treasureRare: "Gemme rare", treasureTrap: "Piège", treasureSteal: "Vol", treasureDouble: "Or double", treasureEmpty: "Vide", treasureSolo: "👤 Solo", treasureMultiplayer: "👥 Multijoueur", treasureGetReady: "Préparez-vous!", treasureRound: "Manche", treasureGoldPts: "Or!", treasureRarePts: "Gemme!", treasureTrapPts: "Piège!", treasureStolen: "Volé!", treasureDoubleActive: "Or double actif!", treasureNothing: "Coffre vide", treasureYouWon: "VICTOIRE! 🏆", treasureGameOver: "Fin de partie!", treasurePlayAgain: "Rejouer"
  },
  es: {
    ...
    matchmaking: "Emparejamiento", joiningQueue: "Uniéndose a la cola...", yourPosition: "Tu Posición", inQueue: "en cola", estimatedWait: "Espera estimada", playersInQueue: "Jugadores en cola", betAmount: "Apuesta", points: "Puntos", leaveQueue: "Salir de la cola", matchFound: "¡Partida encontrada!", getReady: "¡Prepárate!", startingGame: "Iniciando...", botLabel: "Bot", you: "Tú", realPlayer: "Jugador real", loginToPlay: "Inicia sesión para jugar", queueBotFallback: "¿Sin jugadores? El bot se une automáticamente",
    treasureRush: "Fiebre del Tesoro", treasureRushDesc: "¡Abre cofres y recoge oro antes de que se acabe el tiempo!", treasureBoxTypes: "Tipos de cofres", treasureGold: "Oro", treasureRare: "Gema rara", treasureTrap: "Trampa", treasureSteal: "Robo", treasureDouble: "Oro doble", treasureEmpty: "Vacío", treasureSolo: "👤 Individual", treasureMultiplayer: "👥 Multijugador", treasureGetReady: "¡Prepárate!", treasureRound: "Ronda", treasureGoldPts: "¡Oro!", treasureRarePts: "¡Gema!", treasureTrapPts: "¡Trampa!", treasureStolen: "¡Robado!", treasureDoubleActive: "¡Oro doble activo!", treasureNothing: "Cofre vacío", treasureYouWon: "¡GANASTE! 🏆", treasureGameOver: "¡Fin del juego!", treasurePlayAgain: "Jugar de nuevo"
  },
  tr: {
    ...
    matchmaking: "Eşleşme", joiningQueue: "Sıraya giriliyor...", yourPosition: "Sıranız", inQueue: "sırada", estimatedWait: "Tahmini bekleme", playersInQueue: "Sıradaki Oyuncular", betAmount: "Bahis", points: "Puan", leaveQueue: "Sıradan Çık", matchFound: "Eşleşme Bulundu!", getReady: "Hazırlanın!", startingGame: "Başlıyor...", botLabel: "Bot", you: "Sen", realPlayer: "Gerçek Oyuncu", loginToPlay: "Oynamak için giriş yapın", queueBotFallback: "Oyuncu yok mu? Bot otomatik katılır",
    treasureRush: "Hazine Koşusu", treasureRushDesc: "Kutuları aç ve süre bitmeden altın topla!", treasureBoxTypes: "Kutu Türleri", treasureGold: "Altın", treasureRare: "Nadir Mücevher", treasureTrap: "Tuzak", treasureSteal: "Hırsızlık", treasureDouble: "Çift Altın", treasureEmpty: "Boş", treasureSolo: "👤 Tek Oyuncu", treasureMultiplayer: "👥 Çok Oyunculu", treasureGetReady: "Hazırlan!", treasureRound: "Tur", treasureGoldPts: "Altın!", treasureRarePts: "Mücevher!", treasureTrapPts: "Tuzak!", treasureStolen: "Çalındı!", treasureDoubleActive: "Çift Altın Aktif!", treasureNothing: "Boş kutu", treasureYouWon: "KAZANDIN! 🏆", treasureGameOver: "Oyun Bitti!", treasurePlayAgain: "Tekrar Oyna"
  },
  de: {
    ...
    matchmaking: "Matchmaking", joiningQueue: "Warteschlange beitreten...", yourPosition: "Deine Position", inQueue: "in der Warteschlange", estimatedWait: "Geschätzte Wartezeit", playersInQueue: "Spieler in der Warteschlange", betAmount: "Einsatz", points: "Punkte", leaveQueue: "Warteschlange verlassen", matchFound: "Match gefunden!", getReady: "Mach dich bereit!", startingGame: "Spiel startet...", botLabel: "Bot", you: "Du", realPlayer: "Echter Spieler", loginToPlay: "Anmelden zum Spielen", queueBotFallback: "Keine Spieler? Bot tritt automatisch bei",
    treasureRush: "Schatzjagd", treasureRushDesc: "Öffne Kisten und sammle Gold vor Ablauf der Zeit!", treasureBoxTypes: "Kisten-Typen", treasureGold: "Gold", treasureRare: "Seltener Edelstein", treasureTrap: "Falle", treasureSteal: "Diebstahl", treasureDouble: "Doppelgold", treasureEmpty: "Leer", treasureSolo: "👤 Solo", treasureMultiplayer: "👥 Mehrspieler", treasureGetReady: "Mach dich bereit!", treasureRound: "Runde", treasureGoldPts: "Gold!", treasureRarePts: "Edelstein!", treasureTrapPts: "Falle!", treasureStolen: "Gestohlen!", treasureDoubleActive: "Doppelgold aktiv!", treasureNothing: "Leere Kiste", treasureYouWon: "GEWONNEN! 🏆", treasureGameOver: "Spiel vorbei!", treasurePlayAgain: "Nochmal spielen"
  },
  it: {
    ...
    matchmaking: "Ricerca partita", joiningQueue: "Entrando in coda...", yourPosition: "La tua Posizione", inQueue: "in coda", estimatedWait: "Attesa stimata", playersInQueue: "Giocatori in coda", betAmount: "Puntata", points: "Punti", leaveQueue: "Esci dalla coda", matchFound: "Partita trovata!", getReady: "Preparati!", startingGame: "Avvio...", botLabel: "Bot", you: "Tu", realPlayer: "Giocatore reale", loginToPlay: "Accedi per giocare", queueBotFallback: "Nessun giocatore? Il bot si unisce automaticamente",
    treasureRush: "Corsa al Tesoro", treasureRushDesc: "Apri le casse e raccogli oro prima che scada il tempo!", treasureBoxTypes: "Tipi di casse", treasureGold: "Oro", treasureRare: "Gemma rara", treasureTrap: "Trappola", treasureSteal: "Furto", treasureDouble: "Oro doppio", treasureEmpty: "Vuota", treasureSolo: "👤 Singolo", treasureMultiplayer: "👥 Multigiocatore", treasureGetReady: "Preparati!", treasureRound: "Round", treasureGoldPts: "Oro!", treasureRarePts: "Gemma!", treasureTrapPts: "Trappola!", treasureStolen: "Rubato!", treasureDoubleActive: "Oro doppio attivo!", treasureNothing: "Cassa vuota", treasureYouWon: "HAI VINTO! 🏆", treasureGameOver: "Fine partita!", treasurePlayAgain: "Gioca ancora"
  },
  pt: {
    ...
    matchmaking: "Busca de partida", joiningQueue: "Entrando na fila...", yourPosition: "Sua Posição", inQueue: "na fila", estimatedWait: "Espera estimada", playersInQueue: "Jogadores na fila", betAmount: "Aposta", points: "Pontos", leaveQueue: "Sair da fila", matchFound: "Partida encontrada!", getReady: "Prepare-se!", startingGame: "Iniciando...", botLabel: "Bot", you: "Você", realPlayer: "Jogador real", loginToPlay: "Faça login para jogar", queueBotFallback: "Sem jogadores? Bot entra automaticamente",
    treasureRush: "Corrida do Tesouro", treasureRushDesc: "Abra baús e colete ouro antes do tempo acabar!", treasureBoxTypes: "Tipos de baús", treasureGold: "Ouro", treasureRare: "Gema rara", treasureTrap: "Armadilha", treasureSteal: "Roubo", treasureDouble: "Ouro duplo", treasureEmpty: "Vazio", treasureSolo: "👤 Solo", treasureMultiplayer: "👥 Multijogador", treasureGetReady: "Prepare-se!", treasureRound: "Rodada", treasureGoldPts: "Ouro!", treasureRarePts: "Gema!", treasureTrapPts: "Armadilha!", treasureStolen: "Roubado!", treasureDoubleActive: "Ouro duplo ativo!", treasureNothing: "Baú vazio", treasureYouWon: "VENCEU! 🏆", treasureGameOver: "Fim de jogo!", treasurePlayAgain: "Jogar novamente"
  },
  ru: {
    ...
    matchmaking: "Поиск матча", joiningQueue: "Присоединение к очереди...", yourPosition: "Ваша Позиция", inQueue: "в очереди", estimatedWait: "Ожидание", playersInQueue: "Игроки в очереди", betAmount: "Ставка", points: "Очки", leaveQueue: "Покинуть очередь", matchFound: "Матч найден!", getReady: "Готовьтесь!", startingGame: "Запуск...", botLabel: "Бот", you: "Вы", realPlayer: "Реальный игрок", loginToPlay: "Войдите, чтобы играть", queueBotFallback: "Нет игроков? Бот присоединится автоматически",
    treasureRush: "Сокровищница", treasureRushDesc: "Открывай сундуки и собирай золото до конца времени!", treasureBoxTypes: "Типы сундуков", treasureGold: "Золото", treasureRare: "Редкий камень", treasureTrap: "Ловушка", treasureSteal: "Кража", treasureDouble: "Двойное золото", treasureEmpty: "Пусто", treasureSolo: "👤 Соло", treasureMultiplayer: "👥 Мультиплеер", treasureGetReady: "Приготовьтесь!", treasureRound: "Раунд", treasureGoldPts: "Золото!", treasureRarePts: "Камень!", treasureTrapPts: "Ловушка!", treasureStolen: "Украдено!", treasureDoubleActive: "Двойное золото!", treasureNothing: "Пустой сундук", treasureYouWon: "ПОБЕДА! 🏆", treasureGameOver: "Игра окончена!", treasurePlayAgain: "Играть снова"
  },
  hi: {
    ...
    matchmaking: "मैचमेकिंग", joiningQueue: "कतार में शामिल हो रहे हैं...", yourPosition: "आपकी स्थिति", inQueue: "कतार में", estimatedWait: "अनुमानित प्रतीक्षा", playersInQueue: "कतार में खिलाड़ी", betAmount: "दांव", points: "अंक", leaveQueue: "कतार छोड़ें", matchFound: "मैच मिला!", getReady: "तैयार हो जाओ!", startingGame: "शुरू हो रहा है...", botLabel: "बॉट", you: "आप", realPlayer: "असली खिलाड़ी", loginToPlay: "खेलने के लिए लॉगिन करें", queueBotFallback: "कोई खिलाड़ी नहीं? बॉट स्वचालित रूप से आता है",
    treasureRush: "खजाने की दौड़", treasureRushDesc: "बक्से खोलें और समय खत्म होने से पहले सोना इकट्ठा करें!", treasureBoxTypes: "बक्सों के प्रकार", treasureGold: "सोना", treasureRare: "दुर्लभ रत्न", treasureTrap: "जाल", treasureSteal: "चोरी", treasureDouble: "दोगुना सोना", treasureEmpty: "खाली", treasureSolo: "👤 अकेला", treasureMultiplayer: "👥 मल्टीप्लेयर", treasureGetReady: "तैयार हो जाओ!", treasureRound: "राउंड", treasureGoldPts: "सोना!", treasureRarePts: "रत्न!", treasureTrapPts: "जाल!", treasureStolen: "चोरी!", treasureDoubleActive: "दोगुना सोना!", treasureNothing: "खाली बक्सा", treasureYouWon: "जीत गए! 🏆", treasureGameOver: "खेल खत्म!", treasurePlayAgain: "फिर से खेलें"
  },
};
