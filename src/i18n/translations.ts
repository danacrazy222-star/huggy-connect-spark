...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    xpPoints: "Points", gameTickets: "Game Tickets", extraEntries: "Extra Entries", surpriseRewards: "Surprise",
    ...
    login: "Login", signup: "Sign Up", loginSubtitle: "Welcome back to WINLINE", signupSubtitle: "Create your account", displayName: "Display Name", email: "Email", password: "Password", passwordMinLength: "Password must be at least 6 characters", welcomeBack: "Welcome back!", accountCreated: "Account created successfully!", userAlreadyExists: "Account already exists — try logging in instead", invalidCredentials: "Wrong email or password", emailNotConfirmed: "Please confirm your email first", forgotPassword: "Forgot password?", resetPassword: "Reset Password", newPassword: "New Password", confirmNewPassword: "Confirm New Password", passwordsDoNotMatch: "Passwords do not match", resetLinkSent: "Password reset link sent to your email", passwordUpdated: "Password updated successfully!", logout: "Logout",
    ...
    profile: "Profile", loginToViewProfile: "Login to view your profile", inventory: "Inventory", wallet: "Wallet", walletBalance: "Balance", walletCredit: "Credit", walletNote: "Can only be used inside the app", payWithWallet: "Pay with Wallet", payExternal: "Pay", settings: "Settings", clearData: "Clear Data", photoUpdated: "Photo updated!", nameUpdated: "Name updated!", dataCleared: "Data cleared!",
  ...
  ar: {
    ...
    login: "تسجيل الدخول", signup: "إنشاء حساب", loginSubtitle: "مرحباً بعودتك إلى WINLINE", signupSubtitle: "أنشئ حسابك", displayName: "اسم العرض", email: "البريد الإلكتروني", password: "كلمة المرور", passwordMinLength: "كلمة المرور يجب أن تكون 6 أحرف على الأقل", welcomeBack: "مرحباً بعودتك!", accountCreated: "تم إنشاء الحساب بنجاح!", userAlreadyExists: "الحساب موجود مسبقاً — جرب تسجيل الدخول", invalidCredentials: "البريد أو كلمة المرور غلط", emailNotConfirmed: "أكد بريدك الإلكتروني أولاً", forgotPassword: "نسيت كلمة المرور؟", resetPassword: "إعادة تعيين كلمة المرور", newPassword: "كلمة المرور الجديدة", confirmNewPassword: "تأكيد كلمة المرور الجديدة", passwordsDoNotMatch: "كلمات المرور غير متطابقة", resetLinkSent: "تم إرسال رابط إعادة التعيين إلى بريدك", passwordUpdated: "تم تحديث كلمة المرور بنجاح!", logout: "تسجيل الخروج",
    ...
    profile: "الملف الشخصي", loginToViewProfile: "سجّل دخولك لعرض ملفك الشخصي", inventory: "المخزون", wallet: "المحفظة", walletBalance: "الرصيد", walletCredit: "رصيد", walletNote: "يُستخدم فقط داخل التطبيق", payWithWallet: "ادفع من المحفظة", payExternal: "ادفع", settings: "الإعدادات", clearData: "مسح البيانات", photoUpdated: "تم تحديث الصورة!", nameUpdated: "تم تحديث الاسم!", dataCleared: "تم مسح البيانات!",
  ...
  fr: {
    ...
    xpPoints: "Points", gameTickets: "Tickets de jeu", extraEntries: "Entrées bonus", surpriseRewards: "Surprises",
    ...
    login: "Connexion", signup: "Inscription", loginSubtitle: "Bienvenue sur WINLINE", signupSubtitle: "Créez votre compte", displayName: "Nom d'affichage", email: "Email", password: "Mot de passe", passwordMinLength: "Le mot de passe doit contenir au moins 6 caractères", welcomeBack: "Bon retour !", accountCreated: "Compte créé avec succès !", userAlreadyExists: "Ce compte existe déjà — essayez de vous connecter", invalidCredentials: "Email ou mot de passe incorrect", emailNotConfirmed: "Veuillez confirmer votre email", forgotPassword: "Mot de passe oublié ?", resetPassword: "Réinitialiser le mot de passe", newPassword: "Nouveau mot de passe", confirmNewPassword: "Confirmer le mot de passe", passwordsDoNotMatch: "Les mots de passe ne correspondent pas", resetLinkSent: "Lien de réinitialisation envoyé", passwordUpdated: "Mot de passe mis à jour !", logout: "Déconnexion",
    ...
    profile: "Profil", loginToViewProfile: "Connectez-vous pour voir votre profil", inventory: "Inventaire", wallet: "Portefeuille", walletBalance: "Solde", walletCredit: "Crédit", walletNote: "Utilisable uniquement dans l'application", payWithWallet: "Payer avec le portefeuille", payExternal: "Payer", settings: "Paramètres", clearData: "Effacer les données", photoUpdated: "Photo mise à jour !", nameUpdated: "Nom mis à jour !", dataCleared: "Données effacées !",
    ...
    promotionRules: "Règles de la promotion", termsAndConditions: "Conditions générales", promotionalGiveaway: "CADEAU PROMOTIONNEL", drawGiveawayNote: "Ceci est un cadeau promotionnel. L'achat ne garantit pas le gain.", shopPackDisclaimer: "Les achats donnent accès aux livres numériques. Les XP, tickets et entrées sont des bonus promotionnels.",
    promoRulesHowDrawWorks: "Comment fonctionne le tirage", promoRulesHowDrawWorksDesc: "Les utilisateurs achètent des livres numériques qui incluent des bonus promotionnels. Chaque achat éligible donne une entrée au tirage.", promoRulesWinnerSelection: "Sélection du gagnant", promoRulesWinnerSelectionDesc: "Le gagnant est sélectionné au hasard parmi toutes les entrées éligibles. Chaque entrée a une chance égale.", promoRulesDateConditions: "Date et conditions", promoRulesDateConditionsDesc: "Le tirage se termine lorsque le lot éligible est complet ou à la fin de la campagne.", promoRulesRewardsNote: "Récompenses promotionnelles", promoRulesRewardsNoteDesc: "Toutes les récompenses sont des bonus promotionnels sans valeur monétaire.", promoRulesDisclaimer: "Cette promotion est un cadeau. Les achats ne garantissent pas le gain.",
    termsPromotionRules: "Règles de promotion", termsPromotionRulesDesc: "Cette application propose un système de cadeaux promotionnels. Le tirage n'est ni une loterie ni un jeu de hasard.", termsRewardExplanation: "Explication des récompenses", termsRewardExplanationDesc: "XP: Suivez votre progression.\nPoints: Monnaie promotionnelle.\nTickets de jeu: Accès aux jeux.\nTickets Tarot: Accès aux sessions de tarot.\nEntrées: Participation au tirage.\n\nTous les bonus sont promotionnels.", termsRefundPolicy: "Politique de remboursement", termsRefundPolicyDesc: "Les achats sont des livres numériques livrés instantanément. Les remboursements suivent la politique de Google Play.", termsDisclaimer: "Avertissement", termsDisclaimerDesc: "Toutes les récompenses sont promotionnelles et n'ont aucune valeur monétaire. Cette application n'implique pas de jeux d'argent.", termsLastUpdated: "Dernière mise à jour : mars 2026."
  },
  es: {
    ...
    xpPoints: "Puntos", gameTickets: "Boletos de juego", extraEntries: "Entradas extra", surpriseRewards: "Sorpresas",
    ...
    login: "Iniciar sesión", signup: "Registrarse", loginSubtitle: "Bienvenido a WINLINE", signupSubtitle: "Crea tu cuenta", displayName: "Nombre", email: "Correo", password: "Contraseña", passwordMinLength: "La contraseña debe tener al menos 6 caracteres", welcomeBack: "¡Bienvenido de vuelta!", accountCreated: "¡Cuenta creada!", userAlreadyExists: "La cuenta ya existe — intenta iniciar sesión", invalidCredentials: "Correo o contraseña incorrectos", emailNotConfirmed: "Confirma tu correo primero", forgotPassword: "¿Olvidaste la contraseña?", resetPassword: "Restablecer contraseña", newPassword: "Nueva contraseña", confirmNewPassword: "Confirmar contraseña", passwordsDoNotMatch: "Las contraseñas no coinciden", resetLinkSent: "Enlace de restablecimiento enviado", passwordUpdated: "¡Contraseña actualizada!", logout: "Cerrar sesión",
    ...
    profile: "Perfil", loginToViewProfile: "Inicia sesión para ver tu perfil", inventory: "Inventario", wallet: "Billetera", walletBalance: "Saldo", walletCredit: "Crédito", walletNote: "Solo se puede usar dentro de la app", payWithWallet: "Pagar con billetera", payExternal: "Pagar", settings: "Ajustes", clearData: "Borrar datos", photoUpdated: "¡Foto actualizada!", nameUpdated: "¡Nombre actualizado!", dataCleared: "¡Datos borrados!",
    ...
    promotionRules: "Reglas de la promoción", termsAndConditions: "Términos y condiciones", promotionalGiveaway: "SORTEO PROMOCIONAL", drawGiveawayNote: "Este es un sorteo promocional. La compra no garantiza ganar.", shopPackDisclaimer: "Las compras proporcionan acceso a libros digitales. XP, tickets y entradas son bonos promocionales.",
    promoRulesHowDrawWorks: "Cómo funciona el sorteo", promoRulesHowDrawWorksDesc: "Los usuarios compran libros digitales que incluyen bonos promocionales. Cada compra elegible otorga una entrada.", promoRulesWinnerSelection: "Selección del ganador", promoRulesWinnerSelectionDesc: "El ganador se selecciona al azar. Cada entrada tiene la misma probabilidad.", promoRulesDateConditions: "Fecha y condiciones", promoRulesDateConditionsDesc: "El sorteo concluye cuando se completa el lote o cuando finaliza la campaña.", promoRulesRewardsNote: "Recompensas promocionales", promoRulesRewardsNoteDesc: "Todas las recompensas son bonos promocionales sin valor monetario.", promoRulesDisclaimer: "Esta promoción es un sorteo. La compra no garantiza ganar.",
    termsPromotionRules: "Reglas de promoción", termsPromotionRulesDesc: "Esta aplicación ofrece un sistema de sorteos promocionales. No es lotería ni juego de azar.", termsRewardExplanation: "Explicación de recompensas", termsRewardExplanationDesc: "XP: Sigue tu progreso.\nPuntos: Moneda promocional.\nTickets de juego: Acceso a juegos.\nTickets Tarot: Acceso a sesiones de tarot.\nEntradas: Participación en el sorteo.\n\nTodos los bonos son promocionales.", termsRefundPolicy: "Política de reembolso", termsRefundPolicyDesc: "Las compras son libros digitales entregados al instante. Los reembolsos siguen la política de Google Play.", termsDisclaimer: "Descargo de responsabilidad", termsDisclaimerDesc: "Todas las recompensas son promocionales y no tienen valor monetario. Esta app no involucra apuestas.", termsLastUpdated: "Última actualización: marzo 2026."
  },
  tr: {
    ...
    login: "Giriş Yap", signup: "Kayıt Ol", loginSubtitle: "WINLINE'a hoş geldiniz", signupSubtitle: "Hesabınızı oluşturun", displayName: "Görünen Ad", email: "E-posta", password: "Şifre", passwordMinLength: "Şifre en az 6 karakter olmalıdır", welcomeBack: "Tekrar hoş geldiniz!", accountCreated: "Hesap başarıyla oluşturuldu!", userAlreadyExists: "Hesap zaten var — giriş yapmayı deneyin", invalidCredentials: "E-posta veya şifre yanlış", emailNotConfirmed: "Lütfen e-postanızı onaylayın", forgotPassword: "Şifremi unuttum?", resetPassword: "Şifre sıfırla", newPassword: "Yeni şifre", confirmNewPassword: "Şifreyi onayla", passwordsDoNotMatch: "Şifreler eşleşmiyor", resetLinkSent: "Sıfırlama bağlantısı gönderildi", passwordUpdated: "Şifre güncellendi!", logout: "Çıkış",
    ...
    profile: "Profil", loginToViewProfile: "Profilinizi görmek için giriş yapın", inventory: "Envanter", wallet: "Cüzdan", walletBalance: "Bakiye", walletCredit: "Kredi", walletNote: "Yalnızca uygulama içinde kullanılabilir", payWithWallet: "Cüzdanla öde", payExternal: "Öde", settings: "Ayarlar", clearData: "Verileri Temizle", photoUpdated: "Fotoğraf güncellendi!", nameUpdated: "İsim güncellendi!", dataCleared: "Veriler temizlendi!",
    ...
    promotionRules: "Promosyon Kuralları", termsAndConditions: "Şartlar ve Koşullar", promotionalGiveaway: "PROMOSYON HEDİYESİ", drawGiveawayNote: "Bu bir promosyon hediyesidir. Satın alma kazanmayı garanti etmez.", shopPackDisclaimer: "Satın alımlar dijital kitaplara erişim sağlar. XP, biletler ve çekiliş girişleri promosyon bonuslarıdır.",
    promoRulesHowDrawWorks: "Çekiliş nasıl çalışır", promoRulesHowDrawWorksDesc: "Kullanıcılar promosyon bonusları içeren dijital kitap paketleri satın alır. Her uygun satın alma çekilişe giriş hakkı verir.", promoRulesWinnerSelection: "Kazanan seçimi", promoRulesWinnerSelectionDesc: "Kazanan rastgele seçilir. Her giriş eşit şansa sahiptir.", promoRulesDateConditions: "Tarih ve koşullar", promoRulesDateConditionsDesc: "Çekiliş, uygun parti tamamlandığında veya kampanya süresi sona erdiğinde kapanır.", promoRulesRewardsNote: "Promosyon ödülleri", promoRulesRewardsNoteDesc: "Tüm ödüller nakit değeri olmayan promosyon bonuslarıdır.", promoRulesDisclaimer: "Bu promosyon bir hediyedir. Satın alma kazanmayı garanti etmez.",
    termsPromotionRules: "Promosyon kuralları", termsPromotionRulesDesc: "Bu uygulama promosyon çekiliş sistemi sunar. Piyango veya kumar değildir.", termsRewardExplanation: "Ödül açıklaması", termsRewardExplanationDesc: "XP: İlerlemenizi takip edin.\nPuanlar: Promosyon para birimi.\nOyun Biletleri: Oyunlara erişim.\nTarot Biletleri: Tarot seanslarına erişim.\nGirişler: Çekilişe katılım.\n\nTüm bonuslar promosyoneldir.", termsRefundPolicy: "İade politikası", termsRefundPolicyDesc: "Satın alımlar anında teslim edilen dijital kitaplardır. İadeler Google Play politikasına tabidir.", termsDisclaimer: "Sorumluluk reddi", termsDisclaimerDesc: "Tüm ödüller promosyoneldir ve nakit değeri yoktur. Bu uygulama kumar içermez.", termsLastUpdated: "Son güncelleme: Mart 2026."
  },
  de: {
    ...
    xpPoints: "Punkte", gameTickets: "Spieltickets", extraEntries: "Extralose", surpriseRewards: "Überraschungen",
    ...
    login: "Anmelden", signup: "Registrieren", loginSubtitle: "Willkommen bei WINLINE", signupSubtitle: "Erstellen Sie Ihr Konto", displayName: "Anzeigename", email: "E-Mail", password: "Passwort", passwordMinLength: "Passwort muss mindestens 6 Zeichen haben", welcomeBack: "Willkommen zurück!", accountCreated: "Konto erfolgreich erstellt!", userAlreadyExists: "Konto existiert bereits — versuchen Sie sich anzumelden", invalidCredentials: "E-Mail oder Passwort falsch", emailNotConfirmed: "Bitte bestätigen Sie Ihre E-Mail", forgotPassword: "Passwort vergessen?", resetPassword: "Passwort zurücksetzen", newPassword: "Neues Passwort", confirmNewPassword: "Passwort bestätigen", passwordsDoNotMatch: "Passwörter stimmen nicht überein", resetLinkSent: "Link zum Zurücksetzen gesendet", passwordUpdated: "Passwort aktualisiert!", logout: "Abmelden",
    ...
    profile: "Profil", loginToViewProfile: "Melden Sie sich an, um Ihr Profil zu sehen", inventory: "Inventar", wallet: "Geldbörse", walletBalance: "Guthaben", walletCredit: "Kredit", walletNote: "Nur innerhalb der App nutzbar", payWithWallet: "Mit Guthaben bezahlen", payExternal: "Bezahlen", settings: "Einstellungen", clearData: "Daten löschen", photoUpdated: "Foto aktualisiert!", nameUpdated: "Name aktualisiert!", dataCleared: "Daten gelöscht!",
    ...
    promotionRules: "Aktionsregeln", termsAndConditions: "AGB", promotionalGiveaway: "WERBEGESCHENK", drawGiveawayNote: "Dies ist ein Werbegeschenk. Der Kauf garantiert keinen Gewinn.", shopPackDisclaimer: "Käufe bieten Zugang zu digitalen Büchern. XP, Tickets und Einträge sind Werbeboni.",
    promoRulesHowDrawWorks: "So funktioniert die Ziehung", promoRulesHowDrawWorksDesc: "Nutzer kaufen digitale Bücher mit Werbeboni. Jeder Kauf gewährt einen Eintrag.", promoRulesWinnerSelection: "Gewinnerauswahl", promoRulesWinnerSelectionDesc: "Der Gewinner wird zufällig ausgewählt. Jeder Eintrag hat die gleiche Chance.", promoRulesDateConditions: "Datum und Bedingungen", promoRulesDateConditionsDesc: "Die Ziehung endet bei Abschluss des Loses oder am Ende der Kampagne.", promoRulesRewardsNote: "Werbebelohnungen", promoRulesRewardsNoteDesc: "Alle Belohnungen sind Werbeboni ohne Geldwert.", promoRulesDisclaimer: "Diese Aktion ist ein Geschenk. Der Kauf garantiert keinen Gewinn.",
    termsPromotionRules: "Aktionsregeln", termsPromotionRulesDesc: "Diese App bietet ein Werbegeschenksystem. Keine Lotterie oder Glücksspiel.", termsRewardExplanation: "Belohnungserklärung", termsRewardExplanationDesc: "XP: Verfolgen Sie Ihren Fortschritt.\nPunkte: Werbe-Währung.\nSpieltickets: Zugang zu Spielen.\nTarot-Tickets: Zugang zu Tarot.\nEinträge: Teilnahme an der Ziehung.\n\nAlle Boni sind Werbeaktionen.", termsRefundPolicy: "Rückerstattung", termsRefundPolicyDesc: "Käufe sind sofort gelieferte digitale Bücher. Rückerstattungen gemäß Google Play.", termsDisclaimer: "Haftungsausschluss", termsDisclaimerDesc: "Alle Belohnungen sind Werbeaktionen ohne Geldwert. Kein Glücksspiel.", termsLastUpdated: "Letztes Update: März 2026."
  },
  it: {
    ...
    login: "Accedi", signup: "Registrati", loginSubtitle: "Bentornato su WINLINE", signupSubtitle: "Crea il tuo account", displayName: "Nome visualizzato", email: "Email", password: "Password", passwordMinLength: "La password deve avere almeno 6 caratteri", welcomeBack: "Bentornato!", accountCreated: "Account creato con successo!", userAlreadyExists: "Account già esistente — prova ad accedere", invalidCredentials: "Email o password errati", emailNotConfirmed: "Conferma prima la tua email", forgotPassword: "Password dimenticata?", resetPassword: "Reimposta password", newPassword: "Nuova password", confirmNewPassword: "Conferma password", passwordsDoNotMatch: "Le password non corrispondono", resetLinkSent: "Link di reimpostazione inviato", passwordUpdated: "Password aggiornata!", logout: "Esci",
    ...
    profile: "Profilo", loginToViewProfile: "Accedi per vedere il tuo profilo", inventory: "Inventario", wallet: "Portafoglio", walletBalance: "Saldo", walletCredit: "Credito", walletNote: "Utilizzabile solo all'interno dell'app", payWithWallet: "Paga con portafoglio", payExternal: "Paga", settings: "Impostazioni", clearData: "Cancella dati", photoUpdated: "Foto aggiornata!", nameUpdated: "Nome aggiornato!", dataCleared: "Dati cancellati!",
    ...
    promotionRules: "Regole della promozione", termsAndConditions: "Termini e condizioni", promotionalGiveaway: "OMAGGIO PROMOZIONALE", drawGiveawayNote: "Questo è un omaggio promozionale. L'acquisto non garantisce la vincita.", shopPackDisclaimer: "Gli acquisti forniscono accesso ai libri digitali. XP, biglietti e ingressi sono bonus promozionali.",
    promoRulesHowDrawWorks: "Come funziona l'estrazione", promoRulesHowDrawWorksDesc: "Gli utenti acquistano libri digitali con bonus promozionali. Ogni acquisto idoneo dà un ingresso.", promoRulesWinnerSelection: "Selezione del vincitore", promoRulesWinnerSelectionDesc: "Il vincitore è selezionato casualmente. Ogni ingresso ha la stessa possibilità.", promoRulesDateConditions: "Data e condizioni", promoRulesDateConditionsDesc: "L'estrazione termina al completamento del lotto o alla fine della campagna.", promoRulesRewardsNote: "Premi promozionali", promoRulesRewardsNoteDesc: "Tutti i premi sono bonus promozionali senza valore monetario.", promoRulesDisclaimer: "Questa promozione è un omaggio. L'acquisto non garantisce la vincita.",
    termsPromotionRules: "Regole promozione", termsPromotionRulesDesc: "Questa app offre un sistema di omaggi promozionali. Non è una lotteria né gioco d'azzardo.", termsRewardExplanation: "Spiegazione premi", termsRewardExplanationDesc: "XP: Segui i tuoi progressi.\nPunti: Valuta promozionale.\nBiglietti gioco: Accesso ai giochi.\nBiglietti Tarocchi: Accesso al tarot.\nIngressi: Partecipazione all'estrazione.\n\nTutti i bonus sono promozionali.", termsRefundPolicy: "Politica rimborsi", termsRefundPolicyDesc: "Gli acquisti sono libri digitali consegnati istantaneamente. I rimborsi seguono la politica di Google Play.", termsDisclaimer: "Avvertenza", termsDisclaimerDesc: "Tutti i premi sono promozionali senza valore monetario. Nessun gioco d'azzardo.", termsLastUpdated: "Ultimo aggiornamento: marzo 2026."
  },
  pt: {
    ...
    hours: "HORAS", minutes: "MINUTOS", seconds: "SEGUNDOS",
    xpPoints: "Pontos", gameTickets: "Ingressos de jogo", extraEntries: "Entradas extras", surpriseRewards: "Surpresas",
    ...
    login: "Entrar", signup: "Cadastrar", loginSubtitle: "Bem-vindo ao WINLINE", signupSubtitle: "Crie sua conta", displayName: "Nome de exibição", email: "Email", password: "Senha", passwordMinLength: "A senha deve ter pelo menos 6 caracteres", welcomeBack: "Bem-vindo de volta!", accountCreated: "Conta criada com sucesso!", userAlreadyExists: "Conta já existe — tente fazer login", invalidCredentials: "Email ou senha incorretos", emailNotConfirmed: "Confirme seu email primeiro", forgotPassword: "Esqueceu a senha?", resetPassword: "Redefinir senha", newPassword: "Nova senha", confirmNewPassword: "Confirmar senha", passwordsDoNotMatch: "As senhas não coincidem", resetLinkSent: "Link de redefinição enviado", passwordUpdated: "Senha atualizada!", logout: "Sair",
    ...
    profile: "Perfil", loginToViewProfile: "Entre para ver seu perfil", inventory: "Inventário", wallet: "Carteira", walletBalance: "Saldo", walletCredit: "Crédito", walletNote: "Pode ser usado apenas dentro do app", payWithWallet: "Pagar com carteira", payExternal: "Pagar", settings: "Configurações", clearData: "Limpar dados", photoUpdated: "Foto atualizada!", nameUpdated: "Nome atualizado!", dataCleared: "Dados limpos!",
    ...
    promotionRules: "Regras da promoção", termsAndConditions: "Termos e condições", promotionalGiveaway: "SORTEIO PROMOCIONAL", drawGiveawayNote: "Este é um sorteio promocional. A compra não garante a vitória.", shopPackDisclaimer: "As compras fornecem acesso a livros digitais. XP, ingressos e entradas são bônus promocionais.",
    promoRulesHowDrawWorks: "Como funciona o sorteio", promoRulesHowDrawWorksDesc: "Os usuários compram livros digitais com bônus promocionais. Cada compra elegível dá uma entrada.", promoRulesWinnerSelection: "Seleção do vencedor", promoRulesWinnerSelectionDesc: "O vencedor é selecionado aleatoriamente. Cada entrada tem a mesma chance.", promoRulesDateConditions: "Data e condições", promoRulesDateConditionsDesc: "O sorteio termina quando o lote é completado ou ao fim da campanha.", promoRulesRewardsNote: "Recompensas promocionais", promoRulesRewardsNoteDesc: "Todas as recompensas são bônus promocionais sem valor monetário.", promoRulesDisclaimer: "Esta promoção é um sorteio. A compra não garante a vitória.",
    termsPromotionRules: "Regras de promoção", termsPromotionRulesDesc: "Este app oferece um sistema de sorteios promocionais. Não é loteria nem jogo de azar.", termsRewardExplanation: "Explicação das recompensas", termsRewardExplanationDesc: "XP: Acompanhe seu progresso.\nPontos: Moeda promocional.\nIngressos de jogo: Acesso a jogos.\nIngressos Tarot: Acesso ao tarot.\nEntradas: Participação no sorteio.\n\nTodos os bônus são promocionais.", termsRefundPolicy: "Política de reembolso", termsRefundPolicyDesc: "As compras são livros digitais entregues instantaneamente. Reembolsos seguem a política do Google Play.", termsDisclaimer: "Aviso legal", termsDisclaimerDesc: "Todas as recompensas são promocionais sem valor monetário. Sem jogos de azar.", termsLastUpdated: "Última atualização: março 2026."
  },
  ru: {
    ...
    login: "Войти", signup: "Регистрация", loginSubtitle: "Добро пожаловать в WINLINE", signupSubtitle: "Создайте аккаунт", displayName: "Имя", email: "Эл. почта", password: "Пароль", passwordMinLength: "Пароль должен быть не менее 6 символов", welcomeBack: "С возвращением!", accountCreated: "Аккаунт создан!", userAlreadyExists: "Аккаунт уже существует — попробуйте войти", invalidCredentials: "Неверный email или пароль", emailNotConfirmed: "Подтвердите email", forgotPassword: "Забыли пароль?", resetPassword: "Сбросить пароль", newPassword: "Новый пароль", confirmNewPassword: "Подтвердите пароль", passwordsDoNotMatch: "Пароли не совпадают", resetLinkSent: "Ссылка для сброса отправлена", passwordUpdated: "Пароль обновлён!", logout: "Выйти",
    ...
    profile: "Профиль", loginToViewProfile: "Войдите, чтобы увидеть профиль", inventory: "Инвентарь", wallet: "Кошелёк", walletBalance: "Баланс", walletCredit: "Кредит", walletNote: "Можно использовать только в приложении", payWithWallet: "Оплатить кошельком", payExternal: "Оплатить", settings: "Настройки", clearData: "Очистить данные", photoUpdated: "Фото обновлено!", nameUpdated: "Имя обновлено!", dataCleared: "Данные очищены!",
    ...
    promotionRules: "Правила акции", termsAndConditions: "Условия использования", promotionalGiveaway: "ПРОМО РОЗЫГРЫШ", drawGiveawayNote: "Это промо-розыгрыш. Покупка не гарантирует выигрыш.", shopPackDisclaimer: "Покупки дают доступ к цифровым книгам. XP, билеты и входы — промо-бонусы.",
    promoRulesHowDrawWorks: "Как работает розыгрыш", promoRulesHowDrawWorksDesc: "Пользователи покупают цифровые книги с промо-бонусами. Каждая покупка даёт вход в розыгрыш.", promoRulesWinnerSelection: "Выбор победителя", promoRulesWinnerSelectionDesc: "Победитель выбирается случайно. Каждый вход имеет равный шанс.", promoRulesDateConditions: "Дата и условия", promoRulesDateConditionsDesc: "Розыгрыш завершается при выполнении условий или по окончании кампании.", promoRulesRewardsNote: "Промо-награды", promoRulesRewardsNoteDesc: "Все награды — промо-бонусы без денежной стоимости.", promoRulesDisclaimer: "Это промо-розыгрыш. Покупка не гарантирует выигрыш.",
    termsPromotionRules: "Правила акции", termsPromotionRulesDesc: "Это приложение предлагает систему промо-розыгрышей. Не является лотереей или азартной игрой.", termsRewardExplanation: "Описание наград", termsRewardExplanationDesc: "XP: Отслеживайте прогресс.\nОчки: Промо-валюта.\nИгровые билеты: Доступ к играм.\nБилеты Таро: Доступ к Таро.\nВходы: Участие в розыгрыше.\n\nВсе бонусы промо.", termsRefundPolicy: "Политика возврата", termsRefundPolicyDesc: "Покупки — цифровые книги с мгновенной доставкой. Возвраты через Google Play.", termsDisclaimer: "Отказ от ответственности", termsDisclaimerDesc: "Все награды промо и не имеют денежной стоимости. Без азартных игр.", termsLastUpdated: "Последнее обновление: март 2026."
  },
  hi: {
    ...
    login: "लॉगिन", signup: "साइन अप", loginSubtitle: "WINLINE में आपका स्वागत है", signupSubtitle: "अपना खाता बनाएं", displayName: "प्रदर्शन नाम", email: "ईमेल", password: "पासवर्ड", passwordMinLength: "पासवर्ड कम से कम 6 अक्षर का होना चाहिए", welcomeBack: "वापस स्वागत है!", accountCreated: "खाता सफलतापूर्वक बनाया गया!", userAlreadyExists: "खाता पहले से मौजूद है — लॉगिन करें", invalidCredentials: "गलत ईमेल या पासवर्ड", emailNotConfirmed: "पहले अपना ईमेल पुष्टि करें", forgotPassword: "पासवर्ड भूल गए?", resetPassword: "पासवर्ड रीसेट करें", newPassword: "नया पासवर्ड", confirmNewPassword: "पासवर्ड की पुष्टि करें", passwordsDoNotMatch: "पासवर्ड मेल नहीं खाते", resetLinkSent: "रीसेट लिंक भेजा गया", passwordUpdated: "पासवर्ड अपडेट हो गया!", logout: "लॉगआउट",
    ...
    profile: "प्रोफ़ाइल", loginToViewProfile: "अपना प्रोफ़ाइल देखने के लिए लॉगिन करें", inventory: "सामग्री", wallet: "वॉलेट", walletBalance: "शेष", walletCredit: "क्रेडिट", walletNote: "केवल ऐप के अंदर उपयोग किया जा सकता है", payWithWallet: "वॉलेट से भुगतान करें", payExternal: "भुगतान करें", settings: "सेटिंग्स", clearData: "डेटा साफ़ करें", photoUpdated: "फ़ोटो अपडेट हुई!", nameUpdated: "नाम अपडेट हुआ!", dataCleared: "डेटा साफ़ हुआ!",
    ...
    promotionRules: "प्रचार नियम", termsAndConditions: "नियम और शर्तें", promotionalGiveaway: "प्रचार उपहार", drawGiveawayNote: "यह एक प्रचार उपहार है। खरीदारी जीत की गारंटी नहीं देती।", shopPackDisclaimer: "खरीदारी डिजिटल किताबों तक पहुंच प्रदान करती है। XP, टिकट और प्रवेश प्रचार बोनस हैं।",
    promoRulesHowDrawWorks: "ड्रॉ कैसे काम करता है", promoRulesHowDrawWorksDesc: "उपयोगकर्ता प्रचार बोनस के साथ डिजिटल किताब पैकेज खरीदते हैं। प्रत्येक योग्य खरीदारी एक प्रवेश देती है।", promoRulesWinnerSelection: "विजेता चयन", promoRulesWinnerSelectionDesc: "विजेता यादृच्छिक रूप से चुना जाता है। प्रत्येक प्रवेश के पास समान मौका है।", promoRulesDateConditions: "तिथि और शर्तें", promoRulesDateConditionsDesc: "ड्रॉ बैच पूरा होने या अभियान समाप्त होने पर बंद होता है।", promoRulesRewardsNote: "प्रचार पुरस्कार", promoRulesRewardsNoteDesc: "सभी पुरस्कार बिना नकद मूल्य के प्रचार बोनस हैं।", promoRulesDisclaimer: "यह प्रचार एक उपहार है। खरीदारी जीत की गारंटी नहीं देती।",
    termsPromotionRules: "प्रचार नियम", termsPromotionRulesDesc: "यह ऐप प्रचार उपहार प्रणाली प्रदान करता है। लॉटरी या जुआ नहीं है।", termsRewardExplanation: "पुरस्कार विवरण", termsRewardExplanationDesc: "XP: अपनी प्रगति ट्रैक करें।\nअंक: प्रचार मुद्रा।\nगेम टिकट: खेलों तक पहुंच।\nटैरो टिकट: टैरो सत्र तक पहुंच।\nप्रवेश: ड्रॉ में भागीदारी।\n\nसभी बोनस प्रचार हैं।", termsRefundPolicy: "वापसी नीति", termsRefundPolicyDesc: "खरीदारी तुरंत वितरित डिजिटल किताबें हैं। वापसी Google Play नीति के अनुसार।", termsDisclaimer: "अस्वीकरण", termsDisclaimerDesc: "सभी पुरस्कार प्रचार हैं और उनका कोई नकद मूल्य नहीं है। कोई जुआ नहीं।", termsLastUpdated: "अंतिम अपडेट: मार्च 2026।"
  },
};
