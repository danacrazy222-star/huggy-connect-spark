...
export const translations: Record<Language, TranslationKeys> = {
  ...
  pt: {
    ...
    login: "Entrar", signup: "Cadastrar", loginSubtitle: "Bem-vindo ao WINLINE", signupSubtitle: "Crie sua conta", displayName: "Nome de exibição", email: "Email", password: "Senha", passwordMinLength: "A senha deve ter pelo menos 6 caracteres", welcomeBack: "Bem-vindo de volta!", accountCreated: "Conta criada com sucesso!", userAlreadyExists: "Conta já existe — tente fazer login", invalidCredentials: "Email ou senha incorretos", emailNotConfirmed: "Confirme seu email primeiro", logout: "Sair",
