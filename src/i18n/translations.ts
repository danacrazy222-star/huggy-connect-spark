...
export const translations: Record<Language, TranslationKeys> = {
  ...
  de: {
    ...
    login: "Anmelden", signup: "Registrieren", loginSubtitle: "Willkommen bei WINLINE", signupSubtitle: "Erstellen Sie Ihr Konto", displayName: "Anzeigename", email: "E-Mail", password: "Passwort", passwordMinLength: "Passwort muss mindestens 6 Zeichen haben", welcomeBack: "Willkommen zurück!", accountCreated: "Konto erfolgreich erstellt!", userAlreadyExists: "Konto existiert bereits — versuchen Sie sich anzumelden", invalidCredentials: "E-Mail oder Passwort falsch", emailNotConfirmed: "Bitte bestätigen Sie Ihre E-Mail", logout: "Abmelden",
