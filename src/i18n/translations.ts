...
export const translations: Record<Language, TranslationKeys> = {
  ...
  es: {
    ...
    profile: "Perfil", loginToViewProfile: "Inicia sesión para ver tu perfil", inventory: "Inventario", wallet: "Billetera", walletBalance: "Saldo", walletCredit: "Crédito", walletNote: "Solo se puede usar dentro de la app", settings: "Ajustes", clearData: "Borrar datos", photoUpdated: "¡Foto actualizada!", nameUpdated: "¡Nombre actualizado!", dataCleared: "¡Datos borrados!",
