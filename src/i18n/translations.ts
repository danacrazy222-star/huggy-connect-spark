...
export const translations: Record<Language, TranslationKeys> = {
  ...
  de: {
    ...
    profile: "Profil", loginToViewProfile: "Melden Sie sich an, um Ihr Profil zu sehen", inventory: "Inventar", wallet: "Geldbörse", walletBalance: "Guthaben", walletCredit: "Kredit", walletNote: "Nur innerhalb der App nutzbar", settings: "Einstellungen", clearData: "Daten löschen", photoUpdated: "Foto aktualisiert!", nameUpdated: "Name aktualisiert!", dataCleared: "Daten gelöscht!",
