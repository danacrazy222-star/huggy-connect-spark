...
export const translations: Record<Language, TranslationKeys> = {
  ...
  hi: {
    ...
    profile: "प्रोफ़ाइल", loginToViewProfile: "अपना प्रोफ़ाइल देखने के लिए लॉगिन करें", inventory: "सामग्री", wallet: "वॉलेट", walletBalance: "शेष", walletCredit: "क्रेडिट", walletNote: "केवल ऐप के अंदर उपयोग किया जा सकता है", settings: "सेटिंग्स", clearData: "डेटा साफ़ करें", photoUpdated: "फ़ोटो अपडेट हुई!", nameUpdated: "नाम अपडेट हुआ!", dataCleared: "डेटा साफ़ हुआ!",
