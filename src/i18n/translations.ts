...
export const translations: Record<Language, TranslationKeys> = {
  ...
  it: {
    ...
    profile: "Profilo", loginToViewProfile: "Accedi per vedere il tuo profilo", inventory: "Inventario", wallet: "Portafoglio", walletBalance: "Saldo", walletCredit: "Credito", walletNote: "Utilizzabile solo all'interno dell'app", settings: "Impostazioni", clearData: "Cancella dati", photoUpdated: "Foto aggiornata!", nameUpdated: "Nome aggiornato!", dataCleared: "Dati cancellati!",
